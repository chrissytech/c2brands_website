...
function LoginForm() {
  ...
  const handleSignIn = async (e: any) => {
    ...
    try {
      ...
      router.push("/chrissy-only/dashboard"); // Redirect after successful login
    } catch (error) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg_gray px-4 text-[12px] sm:text-[14px] md:text-[16px] lg:text-[17px] xl:text-[18px] 2xl:text-[18px]">
      <form
        ...
        className="bg-white p-6 rounded-[20px] shadow-md max-w-[1200px] "
      >
        <div className=" grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className=" col-span-1">
            {" "}
            <Header3 className=" mb-2">Hello Chrissy!</Header3>
            ...
            <div className=" flex flex-col gap-[18px] ">
              ...
              <div>
                ...
                <div className=" flex justify-end -mt-2">
                  {" "}
                  <Link href="/chrissy-only/auth/forgotpassword">
            ...
            <button
              type="submit"
              className="w-full bg-primary mt-[40px] rounded-[10px] text-white p-2"
            >
